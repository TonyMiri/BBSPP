...
def draw_card(deck, hand, ascii_hand) -> None:
    ...
    if len(deck) >= 1:
        ...
        reset_deck(deck, reshuffle=True, p=hand, d=dealer_hand)
...
#-----
def print_cards(cards_list, d_hand_showing = False):
...
if __name__ == '__main__':
    ...
    while user_credits >= 0:
        ...
        print_cards([dealer_ascii_hand, player_ascii_hand])
        ...
        while calculate_score(player_hand) < 21:
            ...
            #Double Down
                ...
                if len(player_hand) == 2:
                    ...
                    print('You can\'t double down right now. Dummy.')
            else:
        ...
        if p_final > d_final and p_final <= 21:
            ...
            print_cards([dealer_ascii_hand, player_ascii_hand],
                         d_hand_showing=True)
            if p_final == 21 and len(player_hand) == 2:
        ...
        if d_final > p_final and d_final <= 21:
            if d_final == 21 and len(dealer_hand) == 2:
